...
for mono in ['Sa', 'Pe', 'Wa']:#
    for sess in range(0,max(df_dat['session'].loc[df_dat['monkey']==mono])+1): 
        ...
        acc_reactivations_leftIpsi,acc_reactivations_leftIpsi_dist = decode_complex_reactivations(df_serial_left_ipsi,borders_full,mode)
        ...
        acc_reactivations_leftIpsi_dist  = np.array(acc_reactivations_leftIpsi_dist)
        acc_reactivations_leftIpsi_dist = np.concatenate(acc_reactivations_leftIpsi_dist, axis=1)
        
        #contralateral:
        df_serial_left_contra = df_serial_left.loc[targ_right].reset_index()
        
        acc_reactivations_leftContra, acc_reactivations_leftContra_dist= decode_complex_reactivations(df_serial_left_contra,borders_full,mode)
        ...
        acc_reactivations_leftContra_dist  = np.array(acc_reactivations_leftContra_dist)
        acc_reactivations_leftContra_dist = np.concatenate(acc_reactivations_leftContra_dist, axis=1)
        ...
        acc_reactivations_rightIpsi,acc_reactivations_rightIpsi_dist = decode_complex_reactivations(df_serial_right_ipsi,borders_full,mode)
        ...
        acc_reactivations_rightIpsi_dist  = np.array(acc_reactivations_rightIpsi_dist)
        acc_reactivations_rightIpsi_dist = np.concatenate(acc_reactivations_rightIpsi_dist, axis=1)

        #contralateral:
        df_serial_right_contra,df_serial_right_contra_dist = df_serial_right.loc[targ_left].reset_index()
        
        acc_reactivations_rightContra,acc_reactivations_rightContra_dist = decode_complex_reactivations(df_serial_right_contra,borders_full,mode)
        ...
        acc_reactivations_rightContra_dist  = np.array(acc_reactivations_rightContra_dist)
        acc_reactivations_rightContra_dist = np.concatenate(acc_reactivations_rightContra_dist, axis=1)
        ...
        hf = h5py.File('ComplexReactivationStrength_AllMonkeys_IpsiContra.h5', 'a')
        hf.create_dataset(mono+str(sess)+'_borders', data=borders_full)
        
        hf.create_dataset(mono+str(sess)+'_leftIpsi', data=acc_reactivations_leftIpsi)
        hf.create_dataset(mono+str(sess)+'_leftContra', data=acc_reactivations_leftContra)
        hf.create_dataset(mono+str(sess)+'_rightIpsi', data=acc_reactivations_rightIpsi)
        hf.create_dataset(mono+str(sess)+'_rightContra', data=acc_reactivations_rightContra)
        
        hf.create_dataset(mono+str(sess)+'_leftIpsi_dist', data=acc_reactivations_leftIpsi_dist)
        hf.create_dataset(mono+str(sess)+'_leftContra_dist', data=acc_reactivations_leftContra_dist)
        hf.create_dataset(mono+str(sess)+'_rightIpsi_dist', data=acc_reactivations_rightIpsi_dist)
        hf.create_dataset(mono+str(sess)+'_rightContra_dist', data=acc_reactivations_rightContra_dist)
        hf.close()
