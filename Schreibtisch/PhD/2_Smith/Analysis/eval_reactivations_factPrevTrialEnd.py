...
acc_react_all, borders_all = read_reactivations_AllMonkeys('../Results/reactivationStrengthAnd2cue_AllMonkeys.h5', df_dat)#reactivationStrengthAnd2cue_AllMonkeys.h5
...
ttest=[]
pval=[]
steps=48#48 for reactivationStrengthAnd2cue_AllMonkeys# 17 for reactivationStrength2cue_AllMonkeys
