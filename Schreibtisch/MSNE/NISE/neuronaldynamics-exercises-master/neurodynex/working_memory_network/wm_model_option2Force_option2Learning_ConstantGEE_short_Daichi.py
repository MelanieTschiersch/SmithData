...
def simulate_wm(
        ...
        sigma_weight_profile=20., Jpos_excit2excit=1.65, adapt = True, error=180, prev_GEE_center=0*b2.nS, 
...
######################################### NETWORK OPERATIONS #############################################
    ...
    @network_operation(dt=100 *b2.ms)
    def norepinephrin(t):
        K_increase = 0.005*b2.nS*(error-stimulus_center_deg)#0.0005*b2.nS*(error-stimulus_center_deg)
        ...
        tau_NE_decay = 1000*b2.ms#20000*b2.ms#12000*b2.ms
...
def getting_started():
    ...
    result_file = "/home/melanie/Schreibtisch/MSNE/NISE/results/Norepinephrin3001_shortDaichi_Jpos1.65.txt"
