...
def simulate_wm(
        ...
        sigma_weight_profile=20., Jpos_excit2excit=1.6, error=0., 
...
################################# PARAMETER SETTINGS######################################################
    ...
    G_excit2excit += learning_factor*(error/180.)
...
######################################### NETWORK OPERATIONS #############################################
    ...
    b2.run(sim_time)
    return \
        G_excit2excit, rate_monitor_excit, spike_monitor_excit, voltage_monitor_excit, idx_monitored_neurons_excit,\
        rate_monitor_inhib, spike_monitor_inhib, voltage_monitor_inhib, idx_monitored_neurons_inhib,\
        weight_profile_45
