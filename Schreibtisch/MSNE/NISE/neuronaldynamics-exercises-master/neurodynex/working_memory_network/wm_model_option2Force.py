...
def getting_started():
    ...
    rate_monitor_excit, spike_monitor_excit, voltage_monitor_excit, idx_monitored_neurons_excit,\
        ...
        = simulate_wm(N_excitatory=N_e, N_inhibitory=256,
                      weight_scaling_factor=2., sim_time=simtime, poisson_firing_rate=0.9*b2.Hz,
...
#################################################### SAVE TO FILE #################################################################
    ...
    result_file = "/home/melanie/Schreibtisch/MSNE/NISE/results/UndisturbedBumpAveragePosition.txt"
    with open(result_file, "a") as myfile:
        myfile.write(str(stimulus_center)+" "+str(distr_deg_max+180)+" "+str(bump_center*360/(2*numpy.pi))+"\n")
