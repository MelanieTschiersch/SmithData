...
######################################## EXCITATORY POPULATION ##########################################
    ...
    shift_center = (stimulus_center_deg-(distractor_center_deg-stimulus_center_deg))*N_excitatory/360.
    excit_center = excit_pop[int(stimulus_center_deg*N_excitatory/360.-stimulus_width_deg*N_excitatory/(360)):int(stimulus_center_deg*N_excitatory/360.+stimulus_width_deg*N_excitatory/(360))]
    excit_shiftcenter = excit_pop[int(shift_center-distractor_width_deg*N_excitatory/(360.)):int(shift_center+distractor_width_deg*N_excitatory/(360.))]
...
######################################### NETWORK OPERATIONS #############################################
    ...
    b2.run(sim_time)
    return \
        excit_shiftcenter.G_excit2excit, excit_center.G_excit2excit, rate_monitor_excit, spike_monitor_excit, voltage_monitor_excit, idx_monitored_neurons_excit,\
        rate_monitor_inhib, spike_monitor_inhib, voltage_monitor_inhib, idx_monitored_neurons_inhib,\
        weight_profile_45
...
def getting_started():
    ...
    ### Call working memory function ###                 
            G_ee_shift, G_ee, rate_monitor_excit, spike_monitor_excit, voltage_monitor_excit, idx_monitored_neurons_excit,\
                rate_monitor_inhib, spike_monitor_inhib, voltage_monitor_inhib, idx_monitored_neurons_inhib,\
                weight_profile\
