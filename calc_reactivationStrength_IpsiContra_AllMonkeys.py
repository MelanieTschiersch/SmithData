...
for mono in ['Sa','Pe','Wa']:# for each monkey
    ...
    #only use Sa, sess0
        ...
        y = df_serial_left_ipsi['target_prev'].values-np.pi#'response_prev'#'target_prev'
        ...
        y = df_serial_left_contra['target_prev'].values-np.pi
        ...
        y = df_serial_right_ipsi['target_prev'].values-np.pi#'response_prev'#'target_prev'
        ...
        #contralateral:
        df_serial_right_contra = df_serial_right.loc[targ_left].reset_index()
        y = df_serial_right_contra['target_prev'].values-np.pi#'response_prev'#'target_prev'
        ...
        hf = h5py.File('reactivationStrength_AllMonkeys_IpsiContra_0top.h5', 'a')
